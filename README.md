...
<p align="center">
  ...
  <b>BOJ</b> · <b>Programmers</b> · <b>SWEA</b> · <b>LeetCode</b> · <b>Codeforces</b>
</p>
...
| Language | BOJ | Programmers | SWEA | LeetCode | Codeforces |
|----------|:---:|:-----------:|:----:|:--------:|:----------:|
| Java | O | O | O | O | O |
| Python | O | O | O | O | O |
| C++ | O | O | O | O | O |
...
| # | Feature | Description |
|:-:|---------|-------------|
| 1 | [**Fetch Problems**](#fetch-problems) | Fetch problem description & test cases from 5 platforms |
...
| 5 | [**Problem Search**](#problem-search) | Search problems on BOJ (solved.ac), LeetCode, Codeforces, SWEA, Programmers |
...
| 11 | [**GitHub Integration**](#github-integration) | Auto-push accepted solutions to GitHub (BaekjoonHub-style) |
...
<p align="center"><img src="media/demo/fetch-submit.gif" alt="Fetch & Submit Demo" width="700"/></p>
...
<p align="center"><img src="media/demo/random-pick.gif" alt="Random Problem Picker Demo" width="700"/></p>

#### BOJ (solved.ac)
- **Tier Range**: Set desired difficulty range from Bronze V to Ruby I
- **Class Filter**: Filter problems by Class 1–10
- **Algorithm Tag Chips**: Selected tags shown as chips, individually removable with ×
...
<p align="center"><img src="media/demo/template.gif" alt="Code Templates Demo" width="700"/></p>
...
<p align="center"><img src="media/demo/timer.gif" alt="Timer Demo" width="700"/></p>
...
<p align="center"><img src="media/demo/exam-mode.gif" alt="Exam Mode Demo" width="700"/></p>
...
- **All Platforms**: Works with BOJ, Programmers, SWEA, LeetCode, and Codeforces
...
| 언어 | 백준 | 프로그래머스 | SWEA | LeetCode | Codeforces |
|------|:----:|:----------:|:----:|:--------:|:----------:|
| Java | O | O | O | O | O |
| Python | O | O | O | O | O |
| C++ | O | O | O | O | O |
...
| # | 기능 | 설명 |
|:-:|------|------|
| 1 | [**문제 가져오기**](#문제-가져오기) | 5개 플랫폼에서 문제 설명 & 테스트 케이스 자동 추출 |
...
| 5 | [**문제 검색**](#문제-검색) | 백준 (solved.ac), LeetCode, Codeforces, SWEA, 프로그래머스 문제 검색 |
...
| 11 | [**GitHub 연동**](#github-연동) | 맞은 문제 자동 GitHub 푸시 (백준허브 스타일) |
...
<p align="center"><img src="media/demo/fetch-submit.gif" alt="문제 가져오기 & 제출 데모" width="700"/></p>
...
<p align="center"><img src="media/demo/random-pick.gif" alt="랜덤 문제 뽑기 데모" width="700"/></p>
...
- **듣보 문제 제외**: 맞은 사람 N명 이하인 문제 제외 (기준값 사용자 설정 가능)
...
<p align="center"><img src="media/demo/template.gif" alt="코드 템플릿 데모" width="700"/></p>
...
<p align="center"><img src="media/demo/timer.gif" alt="타이머 데모" width="700"/></p>
...
<p align="center"><img src="media/demo/exam-mode.gif" alt="시험 모드 데모" width="700"/></p>
...
- **전 플랫폼 지원**: 백준, 프로그래머스, SWEA, LeetCode, Codeforces 모두 지원
...
- BOJ (Baekjoon): [www.acmicpc.net](https://www.acmicpc.net)
